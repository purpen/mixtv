...
package com.taihuoniao.fineix.tv.view.roundImageView;
...
public class RoundedImageView extends AppCompatImageView {
   ...
   * supported.
   *
   * @param topLeft radius of the top img_button_left_normal corner in px.
   * @param topRight radius of the top img_button_right_normal corner in px.
   * @param bottomRight radius of the bottom img_button_right_normal corner in px.
   * @param bottomLeft radius of the bottom img_button_left_normal corner in px.
   */
